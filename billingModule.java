	...
	public static void main(String args[])throws IOException{
		...
		while(f){
			...
			if(bchoice==1){
				...
				if(ownername.equals("owner")&&ownerpass.equals("rahul")){
					f1=true;
					while(f1){
						System.out.println("\n 1.Add Cashier\n 2.Report\n 3.Exit\n");
									...
									while(f3){
										if(ccchoice==1){
											...
											if(productcount>=0){
												...
												int stockid=sc.nextInt();
													if(stockid==p[stockid-10001].productid){
														p[stockid-10001]=new Product(-10001,null,0,0);
									...
									while(f3){
										if(ccchoice==1){
											if(productcount>=0){
												...
												int ss=sc.nextInt();
												if(pdid-10001<0){
													System.out.println("No product on given Id");
												}
												else{
												f4=true;
												while(f4){
											...
											if(billcount>=0){
												...
												for(i=0;i<=billcount;i++){
													if(billid==b[i].billid){
														...
														int ps=sc.nextInt();
														if((p[pdid-10001].productstock+ps)<=p[pdid-10001].productstock||(p[pdid-10001].productstock+ps)>0){
															if(p[pdid-10001].productid==pdid){
																if(ps<=0){
																	p[pdid-10001].productstock=p[pdid-10001].productstock-ps;
														...
														System.out.println("No stock to update");
														
													}
												}
												else{
														System.out.println("Enter proper Stock Id");
